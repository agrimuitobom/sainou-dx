...
愛媛県立西条農業高等学校の DX（デジタル・トランスフォーメーション）実践と、公開しているリポジトリ・資料をまとめたポータルサイトです。
...
```js
  {
    ...
    downloadUrl: "https://.../app.fmp12",    // 書くとダウンロードボタンが出ます（省略可）
    downloadLabel: "アプリダウンロード",       // そのボタンの文言（省略時は「ダウンロード」）
  },
```
